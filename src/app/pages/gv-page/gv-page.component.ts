...
import content from '../../../../GV_Data_Common.json';
import { IQuestion, IViewQuestion, IChangeAnswerEvent } from '../../defines/question.js';

const MAX_EXECUTION_TIME = 1000 * 60 * 60;
const MAX_QUESTION_IN_TEST = 60;

@Component({
  selector: 'app-gv-page',
  templateUrl: './gv-page.component.html',
  styleUrls: ['./gv-page.component.scss']
})
export class GvPageComponent implements OnInit, OnDestroy {
